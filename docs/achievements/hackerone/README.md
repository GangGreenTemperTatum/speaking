...
### Historical (root directory)
- `h1-leaderboard-q2-2026-*.png/html` - Earlier #5 ranking captures

## #1 US VDP Response Leaderboard - 2026

**Ranked #1 on the HackerOne US VDP Response Leaderboard** for all of 2026, in the Response > Individuals category.

- **Platform**: [HackerOne](https://hackerone.com)
- **Leaderboard**: [US VDP Response Leaderboard - 2026](https://hackerone.com/leaderboard/country?year=2026&country=US&tab=vdp&userTypeTab=individual)
- **Ranking**: #1
- **Handle**: 0xmoose
- **Reputation**: 254
- **Signal**: 7.00
