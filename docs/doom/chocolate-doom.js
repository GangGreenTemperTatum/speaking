...
function findWasmBinary() {
  return locateFile('chocolate-doom.wasm');
}
...
function assignWasmExports(wasmExports) {
  ...
  dynCall_vjii = dynCalls['vjii'] = wasmExports['dynCall_vjii'];
...
// end include: postamble.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'src/chocolate-doom.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_src/chocolate-doom.data');
      }
      Module['addRunDependency']('datafile_src/chocolate-doom.data');
