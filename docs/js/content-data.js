...
const conferences = [
    ...
    {
        id: "defcon-red-team-village-2026",
        name: "DEFCON",
        displayName: "DEFCON 34 Red Team Village",
        year: "2026",
...
const cves = [
    ...
    },
    {
        ...
        title: "CVE-2026-49368 — JetBrains YouTrack",
        organization: "JetBrains",
        product: "YouTrack",
        description: "In JetBrains YouTrack before 2026.1.13162 stored XSS in project notification templates was possible",
        reportContext: "Stored XSS in project notification templates was exploitable via the preview error branch, leading to cross-user JavaScript execution.",
        researcher: "Ads Dawson",
        url: "cves.html?id=cve-2026-49368",
        reportUrl: "https://hackerone.com/reports/3687388",
        state: "PUBLISHED",
        year: "2026",
        date: "2026-05-29",
        ...
        affectedVersion: "before 2026.1.13162",
        unaffectedFrom: "2026.1.13162",
        cwe: "CWE-79",
        cvss: {
            version: "3.1",
            score: 8.7,
        ...
        references: [
            { label: "CVE record", url: "https://www.cve.org/CVERecord?id=CVE-2026-49368" },
            { label: "MITRE CVE JSON", url: "https://cveawg.mitre.org/api/cve/CVE-2026-49368" },
            { label: "JetBrains security advisories", url: "https://www.jetbrains.com/privacy-security/issues-fixed/" },
            { label: "Original HackerOne report", url: "https://hackerone.com/reports/3687388" }
        ],
        icon: "fas fa-shield-halved",
        type: "cve",
        featured: true
    },
    {
        ...
        title: "CVE-2026-57924 — JetBrains YouTrack",
        organization: "JetBrains",
        product: "YouTrack",
        description: "In JetBrains YouTrack before 2026.2.16593 default role configuration exposed excessive user profile details",
        reportContext: "IDOR in recent search APIs allowed accessing another user's search history by substituting the victim's user ID.",
        researcher: "Ads Dawson",
        url: "cves.html?id=cve-2026-57924",
        reportUrl: "https://hackerone.com/reports/3687258",
        state: "PUBLISHED",
        year: "2026",
        date: "2026-06-26",
        ...
        affectedVersion: "before 2026.2.16593",
        unaffectedFrom: "2026.2.16593",
        cwe: "CWE-276",
        cvss: {
            version: "3.1",
            score: 4.3,
        ...
        references: [
            { label: "CVE record", url: "https://www.cve.org/CVERecord?id=CVE-2026-57924" },
            { label: "MITRE CVE JSON", url: "https://cveawg.mitre.org/api/cve/CVE-2026-57924" },
            { label: "JetBrains security advisories", url: "https://www.jetbrains.com/privacy-security/issues-fixed/" },
            { label: "Original HackerOne report", url: "https://hackerone.com/reports/3687258" }
        ],
        icon: "fas fa-shield-halved",
        type: "cve",
        featured: true
    },
    {
        ...
        title: "CVE-2026-57921 — JetBrains YouTrack",
        organization: "JetBrains",
        product: "YouTrack",
        ...
        reportContext: "IDOR in user comment template APIs allowed reading private templates by substituting the victim's user ID.",
        researcher: "Ads Dawson",
        url: "cves.html?id=cve-2026-57921",
        reportUrl: "https://hackerone.com/reports/3687166",
        state: "PUBLISHED",
        year: "2026",
        date: "2026-06-26",
        ...
        references: [
            { label: "CVE record", url: "https://www.cve.org/CVERecord?id=CVE-2026-57921" },
            { label: "MITRE CVE JSON", url: "https://cveawg.mitre.org/api/cve/CVE-2026-57921" },
            { label: "JetBrains security advisories", url: "https://www.jetbrains.com/privacy-security/issues-fixed/" },
            { label: "Original HackerOne report", url: "https://hackerone.com/reports/3687166" }
        ],
        icon: "fas fa-shield-halved",
        type: "cve",
        featured: true
    },
    {
        ...
        title: "CVE-2026-57925 — JetBrains YouTrack",
        organization: "JetBrains",
        product: "YouTrack",
        description: "In JetBrains YouTrack before 2026.2.16593 improper access control allowed reading saved queries and tags",
        reportContext: "A low-privileged user could access personal saved queries and tags belonging to admin users.",
        researcher: "Ads Dawson",
        url: "cves.html?id=cve-2026-57925",
        reportUrl: "https://hackerone.com/reports/3684742",
        state: "PUBLISHED",
        year: "2026",
        date: "2026-06-26",
        ...
        references: [
            { label: "CVE record", url: "https://www.cve.org/CVERecord?id=CVE-2026-57925" },
            { label: "MITRE CVE JSON", url: "https://cveawg.mitre.org/api/cve/CVE-2026-57925" },
            { label: "JetBrains security advisories", url: "https://www.jetbrains.com/privacy-security/issues-fixed/" },
            { label: "Original HackerOne report", url: "https://hackerone.com/reports/3684742" }
        ],
        icon: "fas fa-shield-halved",
        type: "cve",
        featured: true
